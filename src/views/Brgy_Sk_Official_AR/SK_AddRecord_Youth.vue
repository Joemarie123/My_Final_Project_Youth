                  ...
                  <v-card-text>
                    <v-container>
                      ...
                      ></v-select>
                        ...
                        <v-col cols="12" sm="12" md="3">
                          <v-text-field
                            label="Purok/Sitio,Street,House/Bldg.No"
                        ...
                        <v-col cols="12" md="3" sm="12">
                          <v-text-field
                           ...
                           label="Age(As of last Birth Day)"
                           required
                         >
                         </v-text-field>
                      ...
                      ></v-select>
                        ...
                        <v-col cols="12" md="3" sm="12">
                         ...
                         @change="functionselect_civil_status"   
                ...
                <v-card class="mb-12" color="grey lighten-4">
                  <v-card-text>
                    <v-container fluid>
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" sm="12" md="4">
                          ...
                          <v-select 
                        :items="['Bisaya/ Binisaya' , 'Boholano' , 'Cagan/ Kagan' , 'Cebuano' , 'Davawenyo' , 'Dibabawon' , 'Hiligaynon/ Ilongo' , 'Ilocano']"
                   ...
                   <v-col cols="12" sm="12" md="3" class="ma-2" v-show="country_destination">
                        ...
                        <v-col cols="12" sm="12" md="2" class="ma-2" v-show="country_destination">
                          <v-checkbox-group>
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" sm="12" md="4" class="ma-2">
                          ...
                          <v-checkbox-group>
                            ...
                            ></v-checkbox>
                            <v-checkbox
                              label="Pag-asa Youth Association of the Philippines (PYAP)"
                              style="margin-top: -10px"
                            ></v-checkbox>
                        ...
                        <v-col cols="12" sm="12" md="4" class="ma-2">
                          ...
                          <v-checkbox-group>
                            ...
                            ></v-checkbox>
                            <v-checkbox
                              label="Supreme Student Council (SSC)"
                              style="margin-top: -10px"
                            ></v-checkbox>
                            <v-checkbox
                            ...
                            ></v-checkbox>
                            <v-checkbox
                              label="Youth for Peace Movement (YFPM) "
                              style="margin-top: -10px"
                            ></v-checkbox>
                            <v-checkbox
                              label="CVSP Alumni "
                    ...
                    <v-container fluid>
                      ...
                      <v-row> 
                        ...
                        <v-col cols="12" sm="12" md="3" class="ma-2" >
                          ...
                          <v-checkbox-group>
                            <v-checkbox
                              label="Provincial/Municipal DRRMO"
                            ></v-checkbox>
                            <v-checkbox
                              label="Barangay"
                              style="margin-top: -10px"
                    ...
                    <v-container fluid>
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" sm="12" md="4" >
                          ...
                          <v-checkbox-group>
                            <v-checkbox
                              label="Local and National Television Channel"
                            ></v-checkbox>
                            <v-checkbox
                              label="Local, Regional and National Radio Stations"
                              style="margin-top: -10px"
                            ></v-checkbox>
                            <v-checkbox
                            ...
                            ></v-checkbox>
                            <v-checkbox
                              label="Social Media (Facebook, YouTube, Twitter, IG, etc)"
                              style="margin-top: -10px"
                            ></v-checkbox>
                            <v-checkbox
                              label="Barangay Assembly"
                              style="margin-top: -10px"
                            ></v-checkbox>
                            <v-text-field label="Other, specify" ></v-text-field>
                            <v-radio-group >
