          ...
          <v-stepper-items>
            ...
            <v-form ref="formes" v-model="valid" lazy-validation>
                ...
                <v-card id="step1">
                  <v-card-text>
                    ...
                    <!-- <v-form ref="form" v-model="valid" lazy-validation>
                      <v-row>
                        <v-text-field v-model="first_name"  solo outlined label="First Name">
                        </v-text-field>
                      </v-row>
                      <v-row>
                        <v-text-field v-model="last_name"  solo label="Last Name">
                    ...
                    <v-row>
                      ...
                      <v-col cols="12" sm="12" md="3">
                        <v-select v-model="suffix" :items="['Jr.', 'Sr.', 'III', 'N/A']" :rules="rules" label="Suffix"
                      ...
                      <v-col cols="12" sm="6" md="3">
                        <v-text-field v-model="birthDate" @input="calculateAge(birthDate)" label="Date of Birth" outlined
                          type="date" dense color="success" :rules="rules"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="3">
                        <v-text-field label="Age" outlined dense color="success"  :value="years" required>
                        </v-text-field>
                      ...
                      <v-col cols="12" md="3" sm="12">
                        <v-select :items="gender" label="Gender" required outlined dense color="success" :rules="rules">
                        </v-select>
                      </v-col>
                      <v-col cols="12" md="3" sm="12">
                        <v-select :items="religion" label="Religion" required outlined dense color="success" :rules="rules">
                        </v-select>
                      </v-col>
                      <v-col cols="12" md="3" sm="12">
                      ...
                      <v-col cols="12" sm="12" md="3">
                        <v-file-input label="Attached ID here" accept="image/x-png,image/gif,image/jpeg" outlined
                          append-icon="mdi-camera" dense color="success" :rules="rules"></v-file-input>
                      </v-col>
                      ...
                      <v-col cols="12" md="2" sm="12">
                        <v-text-field label="Region" required outlined dense color="success" :rules="rules"></v-text-field>
                      </v-col>
                      <v-col cols="12" md="2" sm="12">
                        <v-text-field label="Province" required outlined dense color="success"
                          :rules="rules"></v-text-field>
                      </v-col>
                      <v-col cols="12" md="2" sm="12">
                        <v-text-field label="Municipality / City" required outlined dense color="success"
                          :rules="rules"></v-text-field>
                      </v-col>
                      <v-col cols="12" md="2" sm="12">
                        <v-text-field label="Barangay" required outlined dense color="success"
                          :rules="rules"></v-text-field>
                      </v-col>
                      ...
                      <v-col cols="12" md="3" sm="6">
                        <v-text-field label="SSS" required outlined dense color="success" :rules="rules"></v-text-field>
                      </v-col>
                      <v-col cols="12" md="3" sm="6">
                        <v-text-field label="TIN" required outlined dense color="success" :rules="rules"></v-text-field>
                      </v-col>
                    </v-row>
                    <!-- </v-form> -->
                ...
                <v-card class="mb-6">
                  <v-col cols="12" md="12" sm="12">
                    ...
                    <div v-for="(item, index) in form" :key="item">
                      <v-row>
                        <v-col cols="12" md="2">
                          <v-text-field outlined label="Training / Vocational Course"  dense color="success" required
                            v-model="item.training_course" autofocus>
                          </v-text-field>
                        </v-col>
                        <v-col cols="12" md="2">
              ...
              <v-stepper-content step="8">
                ...
                <v-btn id="v-btn-c" color="success" @click.stop="dialog = true , validate">
                  Save
                </v-btn>
          ...
          <v-dialog v-model="dialog" max-width="290">
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn color="green darken-1 white--text" @click="dialog = false" type="submit">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
    ...
    methods: {
      ...
      limiter(e) {
        if (e.length > 3) {
          ...
          // console.log('You can only select three skills' , e)
          e.pop()
        }
      }
    },
