                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="3">
                      ...
                      <v-radio-group row>
                        <v-radio
                          label="Yes"
                          value="yes"
                          @click="highest_education = false"
                          color="success"
                        ></v-radio>
                        <v-radio
                          label="No"
                          value="no"
                          @click="highest_education = true"
                          color="success"
                        ></v-radio>
                        <v-container v-show="highest_education">
                          <v-text-field
                            outlined
                            label="Please specify Highest Educational Attainment"
                    ...
                    <v-col cols="12" sm="12" md="6" lg="6">
                      ...
                      <v-radio-group row>
                        <v-radio
                          label="Graduate"
                          @click="(graduate = true), (undergraduate = false)"
                          color="success"
                          value="graduate"
                        >
                        </v-radio>
                        ...
                        <v-radio
                          label="Undergraduate"
                          @click="(graduate = false), (undergraduate = true)"
                          color="success"
                          value="undergraduate"
                        ></v-radio>
                    ...
                    <v-col cols="12" sm="12" md="6" lg="6">
                      ...
                      <v-radio-group row>
                        <v-radio
                          ...
                          color="success"
                          @click="
                            (sec_graduate = true), (sec_undergraduate = false)
                          "
                          value="sec_graduate"
                        >
                        </v-radio>
                        <v-radio
                          ...
                          color="success"
                          @click="
                            (sec_graduate = false), (sec_undergraduate = true)
                          "
                        ...
                        <v-container v-show="sec_graduate">
                          <v-radio-group>
                            <v-radio
                              ...
                              value="non_K"
                              color="success"
                              @click="(non_K = true), (K = false)"
                            ></v-radio>
                            <v-container v-show="non_K">
                              <v-text-field
                                outlined
                                label="Year Graduated"
                                dense
                            ...
                            <v-radio
                              ...
                              value="K"
                              color="success"
                              @click="(non_K = false), (K = true)"
                            ></v-radio>
                          </v-radio-group>
                          <v-container v-show="K">
                            <v-text-field
                              outlined
                    ...
                    <v-col cols="12" sm="12" md="6" lg="6">
                      ...
                      <v-radio-group row>
                        <v-radio
                          ...
                          color="success"
                          @click="
                            (ter_graduate = true), (ter_undergraduate = false)
                          "
                          value="ter_graduate"
                        >
                        </v-radio>
                        <v-radio
                          ...
                          color="success"
                          @click="
                            (ter_graduate = false), (ter_undergraduate = true)
                          "
